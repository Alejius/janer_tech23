...
alumnos.forEach(alumno => {
    console.log (alumno)
    let nuevoAlumno=document.createElement("div")

    nuevoAlumno.innerHTML= "<div class='card mb-3' style='max-width: 540px;'>"+
                            " <div class='row g-0'>"+
                              "<div class='col-md-4'>"+
                                "<img src='./img/alumnos/"+alumno.imagen+"' class='img-fluid rounded-start' alt='Foto'>"+
                              "</div>"+
                              "<div class='col-md-8'>"+
                                "<div class='card-body'>"+
    ...
    tarjeta.appendChild(nuevoAlumno)
